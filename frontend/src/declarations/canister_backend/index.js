...
import { idlFactory } from './canister_backend.did.js';
export { idlFactory } from './canister_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CANISTER_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./canister_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the canister_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./canister_backend.did.js")._SERVICE>}
 */
export const canister_backend = createActor(canisterId);
