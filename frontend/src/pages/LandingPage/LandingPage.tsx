     ...
     <header className="px-6 py-4 flex justify-between items-center bg-white shadow-md border-b border-gray-200 sticky top-0 z-50">
      ...
      <section className=" bg-white border-b border-gray-200">
        <div className="flex flex-col md:flex-row items-center justify-between px-10 pt-20">
            ...
            className=" h-100 max-w-md mt-10 md:mt-0 transform transition-all duration-500 ease-in-out"
            />
        </div>

        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#002AFFBE" fill-opacity="1" d="M0,96L21.8,96C43.6,96,87,96,131,96C174.5,96,218,96,262,117.3C305.5,139,349,181,393,176C436.4,171,480,117,524,128C567.3,139,611,213,655,229.3C698.2,245,742,203,785,186.7C829.1,171,873,181,916,176C960,171,1004,149,1047,154.7C1090.9,160,1135,192,1178,218.7C1221.8,245,1265,267,1309,266.7C1352.7,267,1396,245,1418,234.7L1440,224L1440,320L1418.2,320C1396.4,320,1353,320,1309,320C1265.5,320,1222,320,1178,320C1134.5,320,1091,320,1047,320C1003.6,320,960,320,916,320C872.7,320,829,320,785,320C741.8,320,698,320,655,320C610.9,320,567,320,524,320C480,320,436,320,393,320C349.1,320,305,320,262,320C218.2,320,175,320,131,320C87.3,320,44,320,22,320L0,320Z"></path></svg>
      </section>
